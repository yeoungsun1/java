...
//2번 : 로그인 성공, 아이디/비밀번호 틀렸을 때 확인하기
public class LoginFailMain {
	
	public static void main(String[] args) {
		//User 클래스의 객체를 만들고 ArrayList<User>에 회원 여러명 저장
		//사용자로부터 아이디/비밀번호 입력받기
		//로그인 성공/실패 여부를 구분해서 메시지 출력
		
		//사용할 문법
		//Scanner 클래스 import => alt + shift + o
		//ArrayList<User>
		//.add()	추가메소드
		//.nextLine()	입력메소드
		//boolean 타입의 변수
		...
		users.add(user1);
		users.add(user2);
		users.add(new User("유리", 5, "yuri", "korea1"));
...
//		String userName = "";	//이름 저장용(로그인 성공 시 출력)
//		
//		for(User u : users) {
